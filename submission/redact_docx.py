...
def _address_start(text, anchor):
    ...
    while line_start > 0 and lines < 4:
        ...
        if not (prev.rstrip().endswith(",") or _address_like(prev)):
            # a short building-name line between an organisation line and the street line ("The Samplehouse")
...
def detect_all(segments, nlp=None, min_confidence=0.5):
    ...
    # hyphenated short form of a two-word organisation name: "A-Sam" for "Acme Samples Limited"
